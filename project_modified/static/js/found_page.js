...
function showAddOverlay() {
    ...
    // Dynamically set the backdrop-filter blur value on the background element
  const backgroundElement = document.querySelector(".background");
  if (backgroundElement) {
    backgroundElement.style.backdropFilter = "blur(5px)"; // Adjust the blur value as needed
  }
}
...
function hideAddOverlay() {
    ...
    // Reset the backdrop-filter blur value on the background element
  const backgroundElement = document.querySelector(".background");
  if (backgroundElement) {
    backgroundElement.style.backdropFilter = "none"; // Reset the blur
  }
}
